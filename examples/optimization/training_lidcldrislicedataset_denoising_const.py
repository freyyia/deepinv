...
if supervised:
    ...
    model = dinv.models.ArtifactRemoval(backbone_net=dinv.models.GSDRUNet(act_mode='s', in_channels=1, out_channels=1,
                                    pretrained="download"), mode="direct").to(device)
