...
# defined physics
physics = dinv.physics.Tomography(img_width=imwidth, angles=180, device=device, noise_model=dinv.physics.GaussianNoise(sigma=sigma))
...
if supervised:
    ...
    model = dinv.models.ArtifactRemoval(backbone, pinv=True).to(device)
